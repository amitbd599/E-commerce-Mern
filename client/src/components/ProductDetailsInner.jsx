                            ...
                            <div className="product-details ps-lg-4">
                                ...
                                <div className="product-variant-wrapper">
                                    <div className="product-variant product-variant-color">
                                        ...
                                        <ul className="variant-list list-unstyled d-flex align-items-center flex-wrap">
                                            <li className="variant-item">
                                                <input type="radio" defaultValue="cyan" defaultChecked="" />
                                    ...
                                    <div className="product-variant product-variant-other">
                                        ...
                                        <ul className="variant-list list-unstyled d-flex align-items-center flex-wrap">
                                            <li className="variant-item">
                                                <input type="radio" defaultValue={34} defaultChecked="" />
                    ...
                    <div className="tab-content product-tab-content">
                            ...
                            <div className="row">
                                <div className="col-lg-7 col-md-12 col-12">
                                    <div className="desc-content">
                                        <h4 className="heading_18 mb-3">What is lorem ipsum?</h4>
                                ...
                                <div className="col-lg-5 col-md-12 col-12">
                                    <div className="desc-img">
                                        <img src="https://spreethemesprevious.github.io/bisum/html/assets/img/product.jpg" alt="img" />
                                    </div>
                                </div>
                        ...
                        <div id="pshipping" className="tab-pane fade">
                            <div className="desc-content">
                                ...
                                <p className="text_16 mb-4">
                                    The European law states that when an order is being returned, it
                                    is mandatory for the company to refund the product price and
                                    shipping costs charged for the original shipment. Meaning: one
                                ...
                                <p className="text_16">
                                    Free Shipping: If you placed an order using "free shipping" and
                                    you want to return it, you will be refunded the product price, but
                                    since we paid for the initial shipping, you will pay for the
                                    return.
                                </p>
                            </div>
                        </div>
                        <div id="pstyle" className="tab-pane fade">
                            <div className="desc-content">
                                ...
                                <p className="text_16 mb-4">
                                    Please also bear in mind that shipping goods back and forth
                                    generates greenhouse gases that are accelerating climate change.
                                    We encourage you to choose your items carefully to avoid
                                    unnecessary return shipments.
                                </p>
                                <p className="text_16 mb-4">
                                    You have to pay for return shipping if you want to exchange your
                                    product for another size or the package is returned because it has
                            ...
                            <div className="review-area accordion-parent">
                                ...
                                <div className="review-header d-flex justify-content-between align-items-center">
                                    ...
                                    <button
                                        ...
                                        type="button" onClick={reviewHandel}
                                    >
                                        Write a review
                                    </button>
                                </div>
                                <div className={`review-form-area accordion-child ${review && "d-block"} `}>
                                    <form action="#">
                                        <fieldset>
                                        ...
                                        <button
                                            type="submit"
                                            className="position-relative review-submit-btn"
                                        >
                                            SUBMIT
                                        </button>
                                    </form>
                            ...
                            <Slider {...settings}>
                                {
                                    [...Array(6)].map((item, index) =>
                                        <div className="new-item px-3" data-aos="fade-up" data-aos-duration={300} key={index}>
