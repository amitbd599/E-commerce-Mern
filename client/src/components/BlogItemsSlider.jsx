                                ...
                                <Slider {...settings}>
                                    {
                                        [...Array(item)].map((item, index) =>
                                            <div key={index}
                                                className="article-slick-item px-2"
                                                data-aos="fade-up"
                                            ...
                                            >
                                                <div className="article-card bg-transparent p-0 shadow-none">
                                                    <a className="article-card-img-wrapper" href="article.html">
                                                        <img
                                                            src="https://spreethemesprevious.github.io/bisum/html/assets/img/blog/furniture-1.jpg"
                                                            alt="img"
...
export default BlogItemsSlider