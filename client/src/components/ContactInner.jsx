                            ...
                            <div className="col-lg-4 col-md-6 col-12">
                                <div className="contact-item">
                                    ...
                                    <div className="contact-details">
                                        ...
                                        <a className="contact-info" href="mailto:info@example.com">
                                            info@example.com
                                        </a>
                                        <a className="contact-info" href="mailto:info2@example.com">
                                            info2@example.com
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div className="col-lg-4 col-md-6 col-12">
                                <div className="contact-item">
                                    ...
                                    <div className="contact-details">
                                        ...
                                        <a className="contact-info" href="tel:(201) 555-0124">
                                            (201) 555-0124
                                        </a>
                                        <a className="contact-info" href="tel:(307) 555-0133">
                                            (307) 555-0133
                                        </a>
                                    </div>
                                </div>
                            ...
                            <form action="#" className="contact-form">
                                <div className="row">
                                    ...
                                    <div className="col-md-12 col-12">
                                        ...
                                        <button
                                            type="submit"
                                            className="position-relative review-submit-btn contact-submit-btn"
                                        >
                                            SEND MESSAGE
                                        </button>
                                    </div>
