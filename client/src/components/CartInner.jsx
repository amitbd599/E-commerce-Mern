            ...
            {CartList?.length > 0 ? (
              <div className="row">
                  ...
                  <table className="cart-table w-100">
                    <thead>
                      <tr>
                        ...
                        <th className="cart-caption heading_18">Details</th>
                        <th className="cart-caption text-center heading_18  d-md-table-cell">
                          Quantity
                        </th>
                ...
                <div className="col-xl-5 col-lg-12 col-12">
                  <div className="cart-total-area mt-5 mt-xl-0">
                    <h3 className="cart-total-title  d-block mb-0">
                      Cart Totals
                    </h3>
