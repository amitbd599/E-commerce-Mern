...
const Products = () => {
  ...
  let [activeCatMenu, setActiveCatMenu] = useState(false)
  let catMenuControl = () => {
    setActiveCatMenu(!activeCatMenu)
  }
      ...
      <div className="container">
        <div className="row flex-row-reverse">
          ...
          <div className="col-lg-9 col-md-12 col-12">
            <div className="filter-sort-wrapper d-flex justify-content-between flex-wrap">
              <div className="d-flex justify-content-between align-items-center w-100">
                <div className="collection-title-wrap d-md-flex  align-items-end">
                ...
                <div className="d-lg-none d-block cat__menu">
                  <FaBars onClick={catMenuControl} />
                </div>
              </div>
            </div>
          ...
          <div className="col-lg-3 col-md-12 col-12">
            <div className={`collection-filter filter-drawer ${activeCatMenu && "show"}`}>
              {/* Categories */}
              <div>
                <div className="d-lg-none d-flex justify-content-end cat__menu py-4 mb-2">
                  <FaX onClick={catMenuControl} />
                </div>
              </div>
