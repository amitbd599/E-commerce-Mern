            ...
            <div className="row">
              ...
              >
                <div className="testimonial-container position-relative">
                  <div className="testimonial-slideshow common-slider">
                    <Slider {...settings}>
                      {ReviewList.map((item, index) => (
                        <div className="testimonial-item" key={index}>
                          ...
                          <p className="testimonial-review my-4 text_16">
                            “ I am purchasing furniture from Bisum since the
                            last 6 years. I love their prompt service and so far
                            I have faced no complaints with their furniture.”
                          </p>
