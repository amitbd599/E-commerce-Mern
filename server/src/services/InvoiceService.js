  ...
  try {
    ...
    if (cartProducts.length > 0) {
      ...
      let PaymentSetting = {
        ...
        currency: "BDT",
        success_url: "https://ecommerce-api.amitjs.com/api/v1/payment-success",
        fail_url: "https://ecommerce-api.amitjs.com/api/v1/payment-fail",
        cancel_url: "https://ecommerce-api.amitjs.com/api/v1/payment-cancel",
        ipn_url: "https://ecommerce-api.amitjs.com/api/v1",
